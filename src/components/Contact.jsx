                    ...
                    <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
                        ...
                        <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
                            <div className="lg:w-1/2 px-6">
                                ...
                                <p className="mt-1">1-11-251, TECHNALS Co-working, Staffing & Consulting RKP Mansion, 11, beside Maxi Vision Eye Hospital, Begumpet, Hyderabad, Telangana 500016</p>
                            </div>
                            <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                                <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs">EMAIL</h2>
                                <a className="text-indigo-500 leading-relaxed">laksmiit.infotech@gmail.com</a>
                                <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">PHONE</h2>
                                <p className="leading-relaxed">+91 7897893299  </p>
                            </div>
                        </div>
                    </div>
                    <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                        <h2 className="text-gray-900 text-lg mb-1 font-medium title-font">Contact Our Support Team</h2>
                        <p className="leading-relaxed mb-5 text-gray-600">Have a question, feedback, or need technical assistance? Fill out the form and our team at Lakshmi IT will respond promptly</p>
